...
class velocityfield:
    ...
    def __init__(self, **kwargs):
        ...
        self.fieldset = FieldSet.from_netcdf(
            self.field, self.var, self.dim, time_periodic=timedelta(days=365))
...
class virtualfleet:
    ...
    def simulate(self, **kwargs):
        ...
        dt_run: timedelta
            Time step in hours for the computation
        dt_out: timedelta
            Time step in hours for writing the output
        output_file: str
        ...
        self.pset.execute(self.kernels,
                          ...
                          dt=dt_run,
                          output_file=self.pset.ParticleFile(
            name=output_path, outputdt=dt_out),
